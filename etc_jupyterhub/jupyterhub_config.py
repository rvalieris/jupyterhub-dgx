...
import dgxext
c.JupyterHub.spawner_class = dgxext.PyxisFormSpawner
...
# dont open a new PAM session
# https://jupyterhub.readthedocs.io/en/stable/api/auth.html#jupyterhub.auth.PAMAuthenticator.open_sessions
